...
# set yrange[4:]
plot \
	sprintf("../results/dtlz4-36/%s", f1) u 1:6 w lp ps 0.75 pt 4  pi 10 lw 2 ti "nsga2r, n = 36", \
	sprintf("../results/dtlz4-96/%s", f1) u 1:6 w lp ps 0.75 pt 6  pi 10 lw 2 ti "nsga2r, n = 96", \
	sprintf("../results/dtlz4-36/%s", f2) u 1:6 w lp ps 0.75 pt 5  pi 10 lw 2 ti "algorithm 3, n = 36", \
	sprintf("../results/dtlz4-96/%s", f2) u 1:6 w lp ps 0.75 pt 7  pi 10 lw 2 ti "algorithm 3, n = 96", \
