...
reset
if (coloropt eq "color") { load colorfile } else { load greyfile }
...
if (titleopt eq "true") { set title "zdt4, generation 6" }
...
if (titleopt eq "true") { set title "zdt4, generation 15" }
...
if (titleopt eq "true") { set title "zdt4, generation 36" }
