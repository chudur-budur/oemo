...
plot \
	...
	"../results/dtlz4-12/dtlz4-onsga2r-hv.stat" u 1:2 w lp ps 0.5 pt 2 pi -2 lw 2 ti "algorithm3, n = 12", \
	"../results/dtlz4-60/dtlz4-onsga2r-hv.stat" u 1:2 w lp ps 0.5 pt 5 pi -2 lw 2 ti "algorithm3, n = 60", \
	"../results/dtlz4-96/dtlz4-onsga2r-hv.stat" u 1:2 w lp ps 0.5 pt 7 pi -2 lw 2 ti "algorithm3, n = 96"
# plot \
...
# 	"../results/dtlz4-12/dtlz4-onsga2r-hv.stat"	u 1:2 w l ls 2 lw 6 ti "algorithm3, n = 12", \
# 	"../results/dtlz4-60/dtlz4-onsga2r-hv.stat"	u 1:2 w l ls 4 lw 6 ti "algorithm3, n = 60", \
# 	"../results/dtlz4-96/dtlz4-onsga2r-hv.stat"	u 1:2 w l ls 6 lw 6 ti "algorithm3, n = 96"
