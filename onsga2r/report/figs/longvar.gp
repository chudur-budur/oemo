...
set yrange[4:]
plot \
	sprintf("../results/dtlz4-12/%s", f1)  u 1:6 w lp ps 0.5 pt 1 pi -2 lw 2 ti "nsga2r, n = 12", \
	sprintf("../results/dtlz4-60/%s", f1)  u 1:6 w lp ps 0.5 pt 4 pi -2 lw 2 ti "nsga2r, n = 60", \
	sprintf("../results/dtlz4-96/%s", f1)  u 1:6 w lp ps 0.5 pt 6 pi -2 lw 2 ti "nsga2r, n = 96", \
	sprintf("../results/dtlz4-12/%s", f2)  u 1:2 w lp ps 0.5 pt 2 pi -2 lw 2 ti "algorithm 3, n = 12", \
	sprintf("../results/dtlz4-60/%s", f2)  u 1:2 w lp ps 0.5 pt 5 pi -2 lw 2 ti "algorithm 3, n = 60", \
	sprintf("../results/dtlz4-96/%s", f2)  u 1:2 w lp ps 0.5 pt 7 pi -2 lw 2 ti "algorithm 3, n = 96"
