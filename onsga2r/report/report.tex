...
\begin{algorithmic}[1]
	...
	\WHILE{$t \le N_{\text{gen}}$}
		...
		\FOR{each solution $\mathbf{x_i} \in P'_t$}
			...
			\FOR{each $x_i \in \mathbf{x_c}$}
				\IF{$x_i$ violates the variable bound}
...
\begin{figure*}[tp]
	\centering
	\subfloat[Exploration at generation 9 -- ZDT3 problem\label{subfig:zdt3-gen-3}]{%
		\includegraphics[width=0.5\textwidth]{zdt3-gen-3}}
	\subfloat[Exploration at generation 22 -- ZDT3 problem\label{subfig:zdt3-gen-18}]{%
		\includegraphics[width=0.5\textwidth]{zdt3-gen-18}}
	\hfill
	\subfloat[Exploration at generation 45 -- ZDT3 problem\label{subfig:zdt3-gen-27}]{%
		\includegraphics[width=0.5\textwidth]{zdt3-gen-27}}
	\subfloat[Exploration at generation 6 -- ZDT4 problem\label{subfig:zdt4-gen-21}]{%
...
\begin{figure*}[tp!]
	...
	\subfloat[Convergence test for DTLZ7 problem, hypervolume values for our algorithm can be seen near the extreme top of the graph boundary.\label{subplot:dtlz6-onsga2r}]{%
...
\begin{figure*}[pb!]
	...
	\subfloat[DTLZ7 problem, hypervolume values for our algorithm can be seen near the extreme top of the graph boundary.\label{subplot:dtlz6-nsga2re}]{%
