...
int main (int argc, char **argv)
{
	...
	generate_opposite_population_inverse(parent_pop, op_parent, op_child, 1, overshoot_stat);
	...
	for (i=2; i<=ngen; i++)
	{
		...
		/* some overshoot stats */
		generate_opposite_population_inverse(parent_pop, op_parent, op_child, i, overshoot_stat);
